...
//        System.out.println("result="+data);
    ...
    public static void main(String[] args) {
        File file = new File("D:\\download\\76 取悦儿子的母亲 上-小烟.mp3");
        System.out.println(file.length()/1024);
    }

    public static void  doDownload(String url,String filePath)throws Exception{
        ...
        System.out.println(filePath+",耗时:"+time+" s,大小:"+kb/1024+" M，速度: "+ kb/time +" kb/s");
